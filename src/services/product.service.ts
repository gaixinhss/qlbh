...
export const updateProduct = (code:string,values:Record<string,any>)=>productModel.findOneAndUpdate({code},values,{new:true});
...
export const updateHistoryPrice=(code:string,arr:any)=>productModel.findOneAndUpdate({code},{$push:{priceHistory:arr}})

export const getHistoryPrice=(code:string)=>productModel.find({code},{_id:false,code:true,sellingPrice:true,priceHistory:true})
